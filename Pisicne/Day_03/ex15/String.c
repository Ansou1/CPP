...
** Last update Fri Jan 10 22:22:23 2014 daguen_s
*/
...
static String* split_s(String* this, char separator)
{
  ...
  if (this != NULL)
	...
	ctr++;
      char **tab = malloc((ctr + 1) * sizeof(char **));
      tab[0] = strtok(str, &separator);
      i = 1;
      while ((tab[i++] = strtok(NULL, &separator)));
      String * string_from_tab = malloc(i * sizeof(String));
      while (i--)
	StringInit(&string_from_tab[i], tab[i]);
      return string_from_tab;
    }
  return NULL;
}
